...
<section>
    <div class="menu-section-wrapper">
        ...
        <button aria-label="Navigation menu close button" class="icon-close" on:click={clickHandle}>
        ...
        <a on:click={clickHandle} title="Link to the home page" aria-label="Link to the home page" href="/"  data-sveltekit-reload>   
            <svg id="logo" width="96" height="105" viewBox="0 0 96 105" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="links-container-wrapper">
            <div class="links-container">
                ...
                <div class="links-wrapper">
                    <a title="Cellar page" aria-label="Cellar page" on:click={clickHandle} href="/celler">{menuData.linkCeller}</a>
                    <a title="Vineyard page" aria-label="Vineyard page" on:click={clickHandle} href="/vinyard">{menuData.linkVinyard}</a>
                    <a title="Visits and experiences page" aria-label="Visits and experiences page" on:click={clickHandle} href="/visits">{menuData.linkVisits}</a>
                </div>
            </div>
            <div class="links-container">
                <a  
                    ...
                    href="/wines"
                    title="All wines page" 
                    aria-label="All wines page"
                >
                ...
                <div class="links-wrapper">
                    <a 
                        ...
                        href="/wines"
                        title="White wines page" 
                        aria-label="White wines page"
                    >{menuData.linkWhites}</a>
                    ...
                    <a 
                        ...
                        href="/wines"
                        title="Red wines page" 
                        aria-label="Red wines page"
                    >{menuData.linkReds}</a>
                    ...
                    <a 
                        ...
                        href="/wines"
                        title="Rose wines page" 
                        aria-label="Rose wines page"
                    >{menuData.linkRoses}</a>
                    ...
                    <a 
                        ...
                        href="/wines"
                        title="Collection wines page" 
                        aria-label="Collection wines page"
                    >{menuData.linkCollections}</a>
                </div>
            </div>
            <div class="links-container">
                <p class="heading sofia-font">{menuData.contactUs}</p>
                <div class="links-wrapper">
                    <a title="Business to business page" aria-label="Business to business page" on:click={clickHandle} href="/b2b">{menuData.linkB2b}</a>
                    <a title="Contact page" aria-label="Contact page" on:click={clickHandle} href="/contact">{menuData.linkContact}</a>
                </div>
            </div>
        </div>
        <div class="about-container-wrapper">
            ...
            <div class="about-container">
                <a title="About page" aria-label="About page" on:click={clickHandle} href="/about">{menuData.linkPhilosophy}</a>
                <a title="History page" aria-label="History page" on:click={clickHandle} href="/about#history">{menuData.linkHistory}</a>
                <a title="Team page" aria-label="Team page" on:click={clickHandle} href="/about#team">{menuData.linkTeam}</a>
                <a title="Wine diary page" aria-label="Wine diary page" on:click={clickHandle} href="/diary">{menuData.linkDiary}</a>
                <a title="News page" aria-label="News page" on:click={clickHandle} href="/news">{menuData.linkNews}</a>
            </div>
        </div>
        <div class="contact-container-wrapper desktop">
            <div class="contact-wrapper">
                ...
                <a title="Phone number link" aria-label="Phone number link" href={"tel:"+contact.phoneNumber}>{contact.phoneNumber}</a>
                <a title="Email link" aria-label="Email link" href={"mailto:"+contact.email}>{contact.email}</a>
            </div>
            <div class="law-links">
                <a title="Cookies policy page" aria-label="Cookies policy page" on:click={clickHandle} href="/gdpr">{menuData.linkGDPR}</a>
                <a title="General terms and conditions page" aria-label="General terms and conditions page" on:click={clickHandle} href="/policy">{menuData.linkPolicy}</a>
            </div>
        </div>
    </div>
</section>
